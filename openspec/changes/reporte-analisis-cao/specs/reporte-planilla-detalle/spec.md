...
El sistema SHALL generar un reporte detallado de planillas de avance de obra, mostrando ítem por ítem las cantidades ejecutadas en cada CAO, montos, y avance porcentual, replicando la estructura de la hoja "PLANILLAS" del Excel de referencia.
...
El sistema SHALL agrupar los items por rubro (categoría de obra: M01 Movimiento de Tierras, M02 Pavimento, etc.) y mostrar subtotales por rubro.
