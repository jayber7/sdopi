...
## Purpose
Gestiona datos complementarios a las planillas CAO y proyectos: multas asociadas a planillas, desembolsos programados (curva de inversión), y campos de anticipo contractual en el modelo Proyecto.
